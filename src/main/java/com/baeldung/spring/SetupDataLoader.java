...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Privilege managerPrivilege = createPrivilegeIfNotFound("MANAGE_VIEW_PRIVILEGE");
        ...
        createUserIfNotFound("key@key.com", "Keerthi", "Gadde", "key", new ArrayList<>(Arrays.asList(managerRole)));
